...
public class PatientsResultsDao {
    ...
    private Map<String,LineExtraValues> volumnMap;  // storage for hign and low value
    ...
    public ArrayList<AreaData> getSingleLeftResults(int patients_record_Id) {
        ...
        leftResults.addAll(Arrays.asList(new AreaData("G_and_S_frontomargin",1400.5,1567.5,2000.5),
                    new AreaData("G_and_S_occipital_inf",1500.5,1767.5,2100.5),
                    new AreaData("G_and_S_paracentral",1540.5,1967.5,2000.5),
                    new AreaData("G_and_S_subcentral",1240.5,1367.5,2500.5),
                    new AreaData("G_and_S_transv_frontopol",1240.5,1367.5,2500.5)
                    ));
    ...
    public ArrayList<AreaData> getSingleRightResults(int patients_record_Id) {
            ...
            rightResults.addAll(Arrays.asList(new AreaData("G_and_S_frontomargin",1300.5,1467.5,1900.5),
                    new AreaData("G_and_S_occipital_inf",1850.5,1567.5,2300.5),
                    new AreaData("G_and_S_paracentral",1980.5,1867.5,2200.5),
                    new AreaData("G_and_S_subcentral",1140.5,1567.5,2300.5),
                    new AreaData("G_and_S_transv_frontopol",1340.5,1367.5,2200.5)
            ));
    ...
    //type's value can be chosen in( volumn ,surface , thickness)
    ...
    public Map<String, LineExtraValues> getVolumnMap(ArrayList<AreaData>areaDataList) {

        //for test data
        volumnMap = new HashMap<String, LineExtraValues>() ;
        volumnMap.put("G_and_S_frontomargin",new LineExtraValues<Double>(1200.0,2800.0));
        volumnMap.put("G_and_S_occipital_inf",new LineExtraValues<Double>(1100.0,2700.0));
        volumnMap.put("G_and_S_paracentral",new LineExtraValues<Double>(1200.5,2300.0));
        volumnMap.put("G_and_S_subcentral",new LineExtraValues<Double>(900.0,1901.5));
        volumnMap.put("G_and_S_transv_frontopol",new LineExtraValues<Double>(1400.5,2600.5));
    ...
    public Map<String, LineExtraValues> getThicknessMap(ArrayList<AreaData>areaDataList) {

        //for test data
        thicknessMap = new HashMap<String, LineExtraValues>() ;
        thicknessMap.put("G_and_S_frontomargin",new LineExtraValues<Double>(1200.0,2800.0));
        thicknessMap.put("G_and_S_occipital_inf",new LineExtraValues<Double>(1100.0,2700.0));
        thicknessMap.put("G_and_S_paracentral",new LineExtraValues<Double>(1200.5,2300.0));
        thicknessMap.put("G_and_S_subcentral",new LineExtraValues<Double>(900.0,1901.5));
        thicknessMap.put("G_and_S_transv_frontopol",new LineExtraValues<Double>(1400.5,2600.5));
        return thicknessMap;
    }
    ...
    public Map<String, LineExtraValues> getSurfaceMap(ArrayList<AreaData>areaDataList) {

        //for test data
        surfaceMap = new HashMap<String, LineExtraValues>() ;
        surfaceMap.put("G_and_S_frontomargin",new LineExtraValues<Double>(1200.0,2800.0));
        surfaceMap.put("G_and_S_occipital_inf",new LineExtraValues<Double>(1100.0,2700.0));
        surfaceMap.put("G_and_S_paracentral",new LineExtraValues<Double>(1200.5,2300.0));
        surfaceMap.put("G_and_S_subcentral",new LineExtraValues<Double>(900.0,1901.5));
        surfaceMap.put("G_and_S_transv_frontopol",new LineExtraValues<Double>(1400.5,2600.5));
        return surfaceMap;
    }
